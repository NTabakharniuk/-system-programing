...
public class StudentRestController {
    ...
    public ResponseEntity<ResponseStudentDTO> getStudentById(@PathVariable Long id) {
        logger.info("Received GET request for student with id: {}", id);
    ...
    public ResponseStudentDTO createStudent(@Valid @RequestBody RequestStudentDTO student) {
        logger.info("Received POST request to create student: {}", student);
    ...
    public ResponseEntity<ResponseStudentDTO> updateStudent(
        ...
        logger.info("Received PUT request to update student with id: {}", id);
    ...
    public ResponseEntity<Void> deleteStudent(@PathVariable Long id) {
        logger.info("Received DELETE request to delete student with id: {}", id);
